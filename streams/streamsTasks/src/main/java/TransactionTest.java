...
public class TransactionTest {
    public static void main(String[] args) {
        ...
        //6. Print the value of all trasnsactions from the traders living in Cambridge
        TransactionData.getAll().stream()
        ...
        //8. Find the transaction with the smallest value. Need to print the whole transaction
        // we need to compare objects here
